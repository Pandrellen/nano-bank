...
CFO_PROMPT = (
    ...
    "If the tools contradict the claim, correct it. If the question names a "
    "period list_periods does not offer, say so rather than quietly "
    "substituting another. Never build analysis on a premise you could not "
